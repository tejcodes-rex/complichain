...
const { buildCAClient, registerAndEnrollUser } = require('/mnt/c/student-now-working/fabric-samples/test-application/javascript/CAUtil.js');
const { buildCCPOrg1, buildCCPOrg2, buildWallet } = require('/mnt/c/student-now-working/fabric-samples/test-application/javascript/AppUtil.js');
